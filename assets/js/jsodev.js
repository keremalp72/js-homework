//1.SORU
//Basit İndirim Hesaplama:Bir ürünün fiyatını ve indirim yüzdesini kullanıcıdan alarak, indirimli fiyatı hesaplayan bir program yazın.Örn: 100 TL olan bir ürüne %20 indirim yapıldığında ne kadar ödenmesi gerektiğini hesaplayıp alert ile gösterin.
...
//2.SORU
// Vize ve Final Notu ile Ortalama:Kullanıcıdan vize ve final notunu alarak dönem ortalamasını hesaplayan bir program yazın (vize %40, final %60 etkili olsun).Eğer not 50’den büyükse "Geçtiniz", 50'den küçükse ve 40’tan büyükse "Şartlı geçtiniz", 40’tan küçükse "Kaldınız" mesajını verin.
...
//3.SORU
// Haftanın Günü:​​​​​​​​​​Kullanıcıdan bir sayı alın ve o sayıya karşılık gelen günü yazdırın (1 = Pazartesi, 7 = Pazar). Switch case araştırabilirsiniz.
...
// 4.SORU
// Büyük Sayıyı Bulma:Kullanıcıdan üç sayı alarak, bu sayılardan en büyüğünü bulan bir program yazın.
...
// 5.SORU
// Saniyeyi Saate Çevirme:Kullanıcıdan bir saniye değeri alıp bunu saat, dakika ve saniye cinsine çevirin (Örn: 3661 saniye = 1 saat, 1 dakika, 1 saniye).​​​​​​
...
// console.log(alınanCevap +' saniye= ' + 'Saat: ' + Math.floor(saat) + ' ' + 'Dakika: ' + (Math.floor(kalanDakika)) + ' ' + ' Saniye: ' + (Math.floor(saniye)));
// ---------------------------------------------------------------------------------------------------------------------------------

//6.SORU
// Güncel Yaş Hesaplama:Kullanıcıya önce yıl, sonra ay, sonra gün sorarak tam yaşını gün, ay ve yıl cinsinden hesaplayan bir program yazın.
...
// 7.SORU
// Saatlik Ücret Hesaplama:Kullanıcıdan çalıştığı saat sayısını ve saat başı ücretini alarak toplam kazancını hesaplayın.

// let calisilanSaat = Number(prompt('Kaç Saat Çalıştınız ?'));
// let saatUcret = Number(prompt('Saat Başı Aldığınız Para ?'));

// console.log('Toplam kazancınız: ' + (calisilanSaat * saatUcret));
// ------------------------------------------------------------------------------------------------------------------------

// 8.SORU
// Aylık Taksit Hesaplama:Kullanıcıdan kredi miktarını ve taksit sayısını alarak aylık taksiti hesaplayın.v2 toplam faiz oranını da sorup aylık faizli taksiti hesaplayın.

// let krediMiktari = Number(prompt('Kredi miktarını giriniz: '));
// let taksitSayisi = Number(prompt('Taksit Sayısını giriniz: '));
// console.log('Ödeyeceğiniz aylık taksit tutarı: ' + (krediMiktari / taksitSayisi));

// V2
// let krediMiktari = Number(prompt('Kredi Tutarını Giriniz: '));
// let taksitSayisi = Number(prompt('Taksit Sayısını Giriniz: '));
...
// console.log('Ödenecek aylık taksit fiyatı: ' + aylikTaksit);
// ------------------------------------------------------------------------------------------------------------------------------

// 9.SORU
// Kullanıcı Adı ve Şifre Kontrolü:Kullanıcıdan hem kullanıcı adını hem de şifresini alın.Eğer kullanıcı adı "admin" ve şifre "1234" ise “Giriş başarılı” mesajı verin, aksi halde “Kullanıcı adı veya şifre hatalı” deyin.
...
// 10.SORU
// Net Kar Hesaplama:Satış bedelini ve maliyet (0 girilebilir) girerek; kdv dahil toplam ve net kar bilgilerini gösterin.kdv %20, gelir vergisi %25 olarak hesaplanmalıdır. Eğer 100 TL satış yaparsanız bu tutarın %25'i gelir vergisi olarak hesaplanır.100 TL'lik satış bedelini toplam satış bedeli için kdv dahil 120 TL olarak hesaplarız. Eğer maliyet olduysa (satış bedeli - maliyet) + kdv olacak.
...
// console.log(
//     'KDV DAHİL TOPLAM:' + toplamSatısBedeli + ' ' + 'NET KAR: ' + netKar
// );
// ------------------------------------------------------------------------------------------------------------------------------------

// TAŞ KAĞIT MAKAS SORUSU
...
//     console.log('kullanıcının hamlesi: ' + kullaniciHamle + ' ' + 'bilgisayar hamlesi: ' + bilgisayarHamlesi + ' ' + 'BERABERE');
// }else if(kullaniciHamle == 'taş' && bilgisayarHamlesi == 'kağıt'){
//     console.log('kullanıcının hamlesi: ' + kullaniciHamle + ' ' + 'bilgisayar hamlesi: ' + bilgisayarHamlesi + ' ' + 'KAYBETTİN!');
// }else if(kullaniciHamle == 'taş' && bilgisayarHamlesi == 'makas'){
//     console.log('kullanıcının hamlesi: ' + kullaniciHamle + ' ' + 'bilgisayar hamlesi: ' + bilgisayarHamlesi + ' ' + 'KAZANDIN');
// }
...
// let soru1 = prompt('HTML’de başlık etiketlerinden hangisi en büyük metni gösterir? ' + ' ' + 'A)<h1> B)<h6>');
// soru1Cevap = 'A' ;
// let soru2 = prompt('CSS’te hangi özellik yazı rengini belirler? ' + ' ' + 'A)font-size B)color');
// soru2Cevap = 'B' ;

// let soru3 = prompt('JavaScript’te hangi anahtar kelime değişken tanımlamak için kullanılır? ' + ' ' + 'A)let B)set');
// soru3Cevap = 'A' ;
// let soru4 = prompt('Hangisi bir CSS display değeridir? ' + ' ' + 'A)block B)margin');
// soru4Cevap = 'A' ;

// let soru5 = prompt('Hangisi bir JavaScript veri türüdür? ' + ' ' + 'A)margin B)boolean');
// soru5Cevap = 'B' ;
// let soru6 = prompt('HTML de resim eklemek için hangi etiket kullanılır? ' + ' ' + 'A)<img> B)<div>');
// soru6Cevap = 'A' ;

// let soru7 = prompt('JavaScript’te bir fonksiyonu çağırmak için kullanılan sembol nedir? ' + ' ' + 'A){} B)()');
// soru7Cevap = 'B' ;
// let soru8 = prompt('Hangisi CSS’te bir renk tanımlama yöntemidir? ' + ' ' + 'A)text-align B)rgb(255, 0, 0)');
// soru8Cevap = 'B' ;

// let soru9 = prompt('JavaScript’te bir koşul ifadesi nasıl başlar? ' + ' ' + 'A)if B)while');
// soru9Cevap = 'A' ;
// let soru10 = prompt('HTML formlarında kullanıcıdan bilgi almak için kullanılan etiket hangisidir? ' + ' ' + 'A)<input> B)<span>');
// soru10Cevap = 'A' ;
// dogru = 0;
// yanlis = 0;
// if(soru1 == soru1Cevap){
...
// }
// console.log('DOĞRU SAYISI: ' + dogru + ' ' + 'YANLIŞ SAYISI: ' + yanlis);
...
//     if (hikaye2 === "a") {
//       console.log("Göl kenarına oturup dinleniyorsun, suyun sesi sana huzur veriyor.");
//     } else if (hikaye2 === "b") {
...
//     );
//     if (hikaye5 === "a") {
//       console.log("Geyik seni fark etti ve birkaç adım yaklaştı, göz göze geldiniz.");
//     } else if (hikaye5 === "b") {
...
//   if (hikaye6 === "a") {
//     console.log("Eve mutlu bir şekilde dönüyorsun, doğanın sana sunduğu güzellikleri düşünüyorsun.");
//   } else if (hikaye6 === "b") {
